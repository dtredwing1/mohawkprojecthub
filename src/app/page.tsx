...
export default async function DashboardPage() {
  const [items, adrs, deliverables, activities, strategy] = await Promise.all([
    getOpenItems(),
    getADRs(),
    getDeliverables(),
    getActivities(6),
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 via-slate-900/90 to-sky-950/40 border border-slate-800 p-6 lg:p-8 shadow-xl">
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-400 text-xs font-medium">
            ...
            <span>Autonomous AI Partner Collaboration</span>
          </div>
        ...
        >
          ...
          {urgentItems.length > 0 ? (
            ...
            <div className="mt-2 text-xs text-emerald-400 flex items-center gap-1">
              ...
              <span>All priority queues on track</span>
            </div>
          )}
        </Link>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-semibold text-white">Recent Architecture Decisions (ADRs)</h2>
              </div>
              <Link
                href="/decisions"
